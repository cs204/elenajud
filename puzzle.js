...
знания1.добавить(new Не (БЛжец, БРыцарь))
...
// Задача 3
// А что то сказал, но мы вы не услышали.
// Б сказал: "А сказал 'Я лжец'."
// Б сказал: "В - лжец."
// В сказал: "А - рыцарь."
знания3 = new И()
знания3.добавить(new Эквивалентность(БРыцарь,new Эквивалентность(АРыцарь, АЛжец)))
